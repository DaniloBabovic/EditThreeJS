var SpotLight = function(editorGUI, gui, spot_folder, index, light, target)
{
	...
	*/
	...
	var light_color_gui = folder.addColor( light_color, "currentColor" ).onChange(
																		function(value)
																		{
...
var LightsGUI = function(editorGUI, gui, active_div)
{
	...
	function setAmbientLight()
	{
		...
		var ambient_color = ambient_folder.addColor( a_color, "currentColor" ).onChange(
																					function(value)
																					{
																						if (typeof value === "string") 
																						{
		...
		var bg_color = ambient_folder.addColor( color_bg, "currentColor" ).onChange(
																		function(value)
																		{
																			if (typeof value === "string") 
																			{
	...
	function setFog()
	{
		...
		var fog_color_gui = fog_folder.addColor( fog_color, "currentColor" ).onChange(
																				function(value)
																				{
																					if (typeof value === "string") 
																					{
